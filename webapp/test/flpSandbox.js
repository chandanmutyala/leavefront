		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#leaverequestui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"leaverequestui5-display": {
								"semanticObject": "leaverequestui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=leaverequestui5",
									"url": sap.ui.require.toUrl("leaverequestui5")
								}
							}
						}
					}
